                            ...
                            <div class="row">
                                        ...
                                        <select class="form-control select2" name="category_id" style="width: 100%;">
                                            ...
                                            @foreach ($categories as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ $item->id == $item->category_id ? 'selected' : '' }}>
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('category_id')
                                ...
                                <div class="col-sm-4 form-group">
                                    ...
                                    <input type="text" name="total_quantity" class="form-control"
                                        value="{{ old('total_quantity') ?? $product->total_quantity }}"
                                ...
                                <div class="col-sm-4 form-group">
                                    ...
                                    <input type="text" name="availabel_quantity"
                                        value="{{ old('availabel_quantity') ?? $product->availabel_quantity }}"
                                ...
                                <div class="col-sm-4 form-group">
                                    ...
                                    <input type="text" name="sold_quantity" class="form-control"
                                        value="{{ old('sold_quantity') ?? $product->sold_quantity }}"
                                        id="exampleInputPassword1">
                                    @error('sold_quantity')
                                        <p class="error text-danger">{{ $message }}</p>
                                    @enderror
